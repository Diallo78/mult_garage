...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'vehicles',
        loadComponent: () => import('./components/vehicles/vehicle-list.component').then(m => m.VehicleListComponent)
      },
      {
        path: 'vehicles/new',
      ...
      {
        path: 'visits/new',
        loadComponent: () => import('./components/visits/visit-form-enhanced.component').then(m => m.VisitFormEnhancedComponent)
      },
      {
        path: 'visits/:id',
        loadComponent: () => import('./components/visits/visit-detail.component').then(m => m.VisitDetailComponent)
      },
      {
        path: 'visits/:id/edit',
        loadComponent: () => import('./components/visits/visit-form-enhanced.component').then(m => m.VisitFormEnhancedComponent)
      ...
      {
        path: 'diagnostics',
        loadComponent: () => import('./components/diagnostics/diagnostic-list.component').then(m => m.DiagnosticListComponent)
      },
      {
        path: 'diagnostics/create/:visitId',
        loadComponent: () => import('./components/diagnostics/diagnostic-form.component').then(m => m.DiagnosticFormComponent)
      },
      {
        path: 'diagnostics/:id',
        loadComponent: () => import('./components/diagnostics/diagnostic-detail.component').then(m => m.DiagnosticDetailComponent)
      },
      {
        path: 'quotes',
        loadComponent: () => import('./components/quotes/quote-list.component').then(m => m.QuoteListComponent)
      },
      {
        path: 'quotes/create/:diagnosticId',
        loadComponent: () => import('./components/quotes/quote-form.component').then(m => m.QuoteFormComponent)
      },
      {
        path: 'quotes/:id',
      ...
      {
        path: 'interventions',
        loadComponent: () => import('./components/interventions/intervention-list.component').then(m => m.InterventionListComponent)
      },
      {
        path: 'interventions/create/:quoteId',
        loadComponent: () => import('./components/interventions/intervention-form.component').then(m => m.InterventionFormComponent)
      },
      {
        path: 'interventions/:id',
        loadComponent: () => import('./components/interventions/intervention-detail.component').then(m => m.InterventionDetailComponent)
      },
      {
        path: 'invoices',
      ...
      },
      {
        ...
        loadComponent: () => import('./components/invoices/invoice-form.component').then(m => m.InvoiceFormComponent)
      },
      {
        path: 'invoices/:id',
      ...
      {
        path: 'payments',
        loadComponent: () => import('./components/payments/payment-list.component').then(m => m.PaymentListComponent)
      },
      {
        path: 'payments/create/:invoiceId',
        loadComponent: () => import('./components/payments/payment-form.component').then(m => m.PaymentFormComponent)
      },
      {
        path: 'reports',
