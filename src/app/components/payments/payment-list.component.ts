            ...
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <div class="text-2xl font-bold text-gray-900">
                  \GNF {{ getTotalPayments().toFixed(2) }}
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <div class="text-2xl font-bold text-gray-900">
                  \GNF {{ getMobileMoneyPayments().toFixed(2) }}
                </div>
              </div>
            </div>
          </div>
...
export class PaymentListComponent implements OnInit {
  ...
  filterPayments(): void {
    ...
    if (this.methodFilter) {
      filtered = filtered.filter(
        (payment) => payment.method === this.methodFilter
      );
    }
    ...
    if (this.fromDate) {
      ...
      filtered = filtered.filter(
        (payment) => new Date(payment.date) >= fromDate
      );
    }
  ...
  async downloadReceipt(payment: any) {
    ...
    try {
      ...
      //    'Le téléchargement de votre reçu paiement a été effectué avec succès!'
      //  );
    } catch (error) {
