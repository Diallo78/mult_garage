    ...
    <div class="space-y-6" *ngIf="visit">
      ...
      <div class="card">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label class="text-sm font-medium text-gray-500">Visit Date</label>
      ...
      <div class="card" *ngIf="visit.driverId">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <label class="text-sm font-medium text-gray-500">Name</label>
            <p class="mt-1 text-sm text-gray-900">{{ visit.driverId }}</p>
          </div>
        </div>
      </div>
      ...
      <!-- Reported Issues -->
      <div class="card">
        <h3 class="text-lg font-medium text-gray-900 mb-4">Reported Issues</h3>
        <div class="space-y-2">
